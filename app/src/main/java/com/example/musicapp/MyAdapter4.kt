...
class MyAdapter4(var context: Context,var datalist: ArrayList<DataX>) : RecyclerView.Adapter<MyAdapter4.ViewHolder>() {
    private var mediaPlayer: MediaPlayer? = null
    private var currentPlayingPosition: Int = -1
    class ViewHolder(var binding: EachListBinding) : RecyclerView.ViewHolder(binding.root){

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view=EachListBinding.inflate(LayoutInflater.from(context),parent,false)
